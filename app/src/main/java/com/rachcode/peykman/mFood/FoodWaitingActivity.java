package com.rachcode.peykman.mFood;
...
import com.rachcode.peykman.model.TransaksiFood;
...
import com.rachcode.peykman.model.json.fcm.FoodDriverRequest;
...
public class FoodWaitingActivity extends AppCompatActivity {
    ...
    private void sendMessage(FoodDriverRequest request) {
        ...
        parameter.settransaction_id(foodDriverRequest.getIdTransaksi());
            ...
            public void onResponse(Call<CheckStatusTransaksiResponse> call, Response<CheckStatusTransaksiResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (checkStatus.isStatus()) {
                        ...
                        request.setOriginAddress(foodDriverRequest.getAlamatAsal());
                        request.setDestinationAddress(foodDriverRequest.getAlamatTujuan());
                        request.setDistance(foodDriverRequest.getJarak());
/*
                        request.setPrice(foodDriverRequest.getHarga());
*/
                        request.setid(foodDriverRequest.getIdTransaksi());
