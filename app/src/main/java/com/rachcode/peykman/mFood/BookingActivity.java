...
import com.rachcode.peykman.model.Makanan;
...
public class BookingActivity extends AppCompatActivity implements MakananItem.OnCalculatePrice {
    ...
    private MfoodPartner mitraHarga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isRestoranMitra) {
            mPayDiscount.setText("Diskon " + mitraHarga.getDiscount() + " if using a wallet");
        } else {
            mPayDiscount.setText("Diskon " + designedFitur.getDiscount() + " if using a wallet");
        }
    ...
    private void updateCostPrice() {
        if (isRestoranMitra) {
            deliveryCostBeforeDiscLong = Long.parseLong(mitraHarga.getPrice());
        } else {
            deliveryCostBeforeDiscLong = designedFitur.getPrice();
        }
