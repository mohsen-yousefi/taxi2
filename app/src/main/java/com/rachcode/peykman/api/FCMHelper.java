...
import com.rachcode.peykman.utils.BooleanSerializerDeserializer;
...
import static com.rachcode.peykman.utils.Log.LOG;
...
public class FCMHelper {
    ...
    public static Call sendMessage(String serverKey, FCMMessage message) {
        ...
        Request request = new Request.Builder()
                .url("http://androidamooz.ir/utaxi/api.php/Notif/android")
