...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discountText.setText("Diskon " + selectedFitur.getDiscount() + " if using a wallet");
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case R.id.service_mpay:
                        pakaiMpay = 1;
                        biayaTotal = (long) (harga * Integer.parseInt(selectedFitur.getFinalPrice()));
    ...
    private void CalculateBiaya() {
        ...
        if (serviceMpay.isChecked()) {
            biayaTotal = (long) (biayaTotal * Integer.parseInt(selectedFitur.getFinalPrice()));
        }
        ...
        if (userLogin.getmPaySaldo() < (harga * Integer.parseInt(selectedFitur.getFinalPrice()))) {
    ...
    private void onOrderButtonClick() {
        if (driverAvailable.isEmpty()) {
            ...
            param.setOrderFitur(String.valueOf(selectedFitur.getIdFeature()));
