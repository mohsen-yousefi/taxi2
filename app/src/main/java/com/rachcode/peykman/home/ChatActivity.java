...
import com.rachcode.peykman.adapter.ChatAdapter;
import com.rachcode.peykman.adapter.ItemListener;
...
import com.rachcode.peykman.utils.AsyncTaskHelper;
...
import static com.rachcode.peykman.service.GoTaxiMessagingService.BROADCAST_ACTION;
...
//        arrChat = initDataDummy();
        ...
        butSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UserData user = GoTaxiApplication.getInstance(getApplicationContext()).getLoginUserD();
                chat.isi_chat = inputText.getText().toString();
                chat.reg_id_tujuan = user.getRegId();
                chat.nama_tujuan = user.getFirstName() + " " + user.getLastName();
                chat.chat_from = 1;
